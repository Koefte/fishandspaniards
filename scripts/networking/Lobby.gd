...
@onready var host_button: Button = get_node_or_null("MarginContainer/MainVBox/TopControlsHBox/HostButton")
@onready var join_button: Button = get_node_or_null("MarginContainer/MainVBox/TopControlsHBox/JoinButton")
@onready var id_input: LineEdit = get_node_or_null("MarginContainer/MainVBox/TopControlsHBox/IdInput")
@onready var lobby_id_label: Label = get_node_or_null("MarginContainer/MainVBox/LobbyInfoHBox/LobbyIdLabel")
@onready var copy_id_button: Button = get_node_or_null("MarginContainer/MainVBox/LobbyInfoHBox/CopyIdButton")
@onready var player_count_label: Label = get_node_or_null("MarginContainer/MainVBox/PlayerListPanel/PlayerListMargin/PlayerListVBoxContainer/PlayerCountLabel")
@onready var player_list_vbox: VBoxContainer = get_node_or_null("MarginContainer/MainVBox/PlayerListPanel/PlayerListMargin/PlayerListVBoxContainer/PlayerListScroll/PlayerListVBox")
@onready var start_button: Button = get_node_or_null("MarginContainer/MainVBox/BottomActionHBox/StartButton")
@onready var status_label: Label = get_node_or_null("MarginContainer/MainVBox/BottomActionHBox/StatusLabel")
